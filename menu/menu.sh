...
echo -e " ${z}╚══════════════════════════════════════════════════════════╝${NC}"
echo -e "       ╔═════════════════════════════════════════════╗${NC}" | lolcat
echo -e "           SSH/OPENVPNC${NC}    $y=$NC $ssh1${NC}" "$a"
...
echo -e " ${z}║$NC [${r}04${NC}] TROJAN MENU$NC  ${z}║$NC [${r}11${NC}] SPEEDTEST$NC   ${z} ║$NC [${r}18${NC}] DOMAIN      $NC${z}║$NC" 
echo -e " ${z}║$NC [${r}05${NC}] SHADOW MENU$NC  ${z}║$NC [${r}12${NC}] RUNNING$NC     ${z} ║$NC [${r}19${NC}] CERT SSL    $NC${z}║$NC"
...
0) clear ; menu ;;
00) exit ;;
*) echo -e "" ; echo "salah tekan" ; sleep 1 ; menu ;;
esac
